...
class SupplierTest
{
	...
	void testVerifySale()
	{
		...
		OrderValidation act= tested.verifyandApplySale(new OrderValidation(0, 49, null, 100, 5, 1));

		assertEquals(4900, act.getPrice());
		
		act= tested.verifyandApplySale(new OrderValidation(0, 50, null, 100, 5, 1));
